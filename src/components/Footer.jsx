      ...
      >
        ...
        <div className="relative z-10 border-t border-white/10">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex items-center justify-center">
            <p className="font-montserrat text-xs text-white/40 tracking-wide">
              This website is made by{' '}
              <button
                onClick={() => setShowDevCard(true)}
                className="font-semibold text-white/70 hover:text-white transition-colors duration-200 underline underline-offset-2 decoration-white/30 hover:decoration-white/70 focus:outline-none focus-visible:ring-1 focus-visible:ring-white/50 rounded-sm"
